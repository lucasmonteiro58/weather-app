<template>
  <div class="text-gray-150 p-10 flex-grow">
    <div class="space-x-3 text-right">
      <button
        class="bg-gray-150 rounded-full w-10 h-10 text-secondary font-bold text-xl"
      >
        &deg;C
      </button>
      <button
        class="bg-[#585676] rounded-full w-10 h-10 text-gray-150 font-bold text-xl"
      >
        &deg;F
      </button>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 justify-center">
        <LargeCard>
          <!-- <div class="flex justify-between space-x-5 items-center">
              <div class="bg-gray-500 rounded-full w-[30px] h-[30px] flex justify-center items-center">
